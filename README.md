...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/geeet-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12242&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/geeet-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `geeet` can be installed with:

```
conda install geeet
```

It is possible to list all of the versions of `geeet` available on your platform with:
